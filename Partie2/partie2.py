...
"""
# => a faire apres le fine tuning sur tout le modele dont la premier couche est gelé
epochs = 1
...
for batch_size in batchs_size:
    ...
    plt.ylabel("accuracy")
    plt.legend()
    fig.savefig('NASNetMobile_{}_epoch_{}_batchsize.jpg'.format(epochs, batch_size), bbox_inches='tight', dpi=300)
"""
